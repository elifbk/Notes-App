...
const Main = ({ availableTags, notes }: Props) => {
   ...
   * 2) 2. input ile seçilen etiketler note'un içerisindeki etiketler ile birebir eşleşmelidir. Seçilen etiketler dizisindeki her bir etiket için note'a ait etiketler arasında eşleşme kontrolü yapıcaz

    **every = dizideki bütün elemanlar verilen koşula uyuyor mu kontrol eder
    **some = dizideki elemanlardan en az biri verilen koşula uyuyor mu kontrol eder
   */
    ...
    <Container className="mx-auto py-5">
      ...
      <Stack direction="horizontal" className="justify-content-between mb-4">
        <div className="d-flex gap-3 align-items-center">
          <img width={45} src="/note_logo.png" alt="note-logo" />
          <h1>Notlar</h1>
        </div>
